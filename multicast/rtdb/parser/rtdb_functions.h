...
int addSharedItem(rtdb_ItemList* , char*  );
...
//Add a network to the network global list if it wasn't previouly declared
rtdb_Network* networkCreate(char* );
//Add an item to the shared items list in the network specified if it wasn't previouly defined
void networkAddSharedItem(rtdb_Network* , char* );
