...
#define _ERR_NETWORKOPEN_ "Something goes wrong while creating a new network"
#define _ERR_NETWORKFIELD_ "Something goes wrong while creating inserting a field in a network"
